      ...
      highlight_overrides = {
        all = function(colors)
          return {
            ...
            -- MiniClueBorder = { fg = colors.surface0 },
            -- MiniClueDescGroup = { fg = colors.mauve, style = { "bold" } },
            -- MiniClueDescSingle = { fg = colors.text },
            -- MiniClueNextKey = { fg = colors.peach, style = { "bold" } },
            -- MiniClueNextKeyWithPostkeys = { fg = colors.blue, style = { "bold" } },
            -- MiniClueSeparator = { fg = colors.overlay0 },
            -- MiniClueTitle = { fg = colors.blue, style = { "bold" } },
